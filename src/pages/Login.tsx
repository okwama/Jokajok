          ...
          <CardContent>
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div className="flex items-center justify-between">
                <div className="flex items-center">
                  ...
                  />
                  <label htmlFor="remember-me" className="ml-2 block text-sm text-swahili-dust-600">
                    Remember me
                  </label>
                </div>
            ...
            <div className="mt-6 text-center">
              <p className="text-sm text-swahili-dust-600">
                ...
                <Link to="/register" className="font-medium text-copper-600 hover:text-copper-500">
                  Sign up here
                </Link>
              </p>
            </div>
