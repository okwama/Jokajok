                ...
                {items.map((item) => (
                  <div key={item.id} className="flex items-center space-x-3">
                    ...
                    <div className="flex-1">
                      ...
                      <p className="text-sm text-swahili-dust-600">Qty: {item.quantity}</p>
                    </div>
                    <span className="font-semibold">${(item.price * item.quantity).toFixed(2)}</span>
                  </div>
                ))}

                <div className="border-t border-swahili-dust-200 pt-4 space-y-2">
                  ...
                  <div className="flex justify-between text-lg font-bold">
                    <span>Total</span>
                    <span className="text-copper-600">${total.toFixed(2)}</span>
                  </div>
                </div>

                <div className="space-y-3 pt-4">
                  <div className="flex items-center text-sm text-swahili-dust-600">
